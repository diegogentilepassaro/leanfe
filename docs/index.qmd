...
### ⚡ Speed
**Polars backend** delivers blazing fast performance for in-memory datasets. Process millions of observations in seconds.
:::
...
[View detailed benchmarks →](benchmarks/overview.qmd)
