...
leanfe automatically uses **YOCO compression** for IID and HC1 standard errors, compressing data by 10-1000x for discrete regressors. This makes it extremely fast even on large datasets.
